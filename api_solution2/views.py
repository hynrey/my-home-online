...
from api_solution2.serializers import EntitySerializer
from api_solution2.models import Entity
...
class EntityView(APIView):
    ...
    @extend_schema(
        request=inline_serializer(
            name="Solution2RequestInline",
            fields={
                "data[value]": serializers.IntegerField(),
            },
        ),
    )
